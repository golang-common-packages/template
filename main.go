...
func main() {
	...
	bookUsecase := bookUsercase.New(bookRepo, cfg.GetString("database.mongodb.dbName"), cfg.GetString("database.mongodb.bookCollName"))

	bookHttpDelivery.New(e, bookUsecase)
